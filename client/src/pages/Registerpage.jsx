    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-muted mb-6">Start collaborating with your team</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full justify-center py-2">
              {loading ? <i className="ti ti-loader-2 animate-spin" /> : 'Create Account'}
            </button>
          </form>
          ...
          <a href="/api/auth/google" className="btn-secondary w-full justify-center py-2">
